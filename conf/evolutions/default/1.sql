...
create table "posts" ("ID" VARCHAR NOT NULL PRIMARY KEY,"ITEM_TITLE" VARCHAR NOT NULL,"TYPE" INTEGER NOT NULL,"DATE_CREATED" TIMESTAMP NOT NULL,"AUTHOR" VARCHAR NOT NULL,"CONTENT" VARCHAR NOT NULL,"EXTRA_DATA" VARCHAR NOT NULL,"DRAFT" BOOLEAN NOT NULL,"USER_ID" INTEGER);
