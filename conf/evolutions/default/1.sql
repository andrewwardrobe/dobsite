...
create table `posts` (`ID` VARCHAR(254) NOT NULL PRIMARY KEY,`ITEM_TITLE` VARCHAR(254) NOT NULL,`TYPE` INTEGER NOT NULL,`DATE_CREATED` TIMESTAMP NOT NULL,`AUTHOR` VARCHAR(254) NOT NULL,`CONTENT` VARCHAR(254) NOT NULL,`EXTRA_DATA` VARCHAR(254) NOT NULL,`DRAFT` BOOLEAN NOT NULL,`USER_ID` INTEGER);
