...
create table "posts" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"ITEM_TITLE" VARCHAR NOT NULL,"TYPE" INTEGER NOT NULL,"DATE_CREATED" TIMESTAMP NOT NULL,"AUTHOR" VARCHAR NOT NULL,"CONTENT" VARCHAR NOT NULL);
